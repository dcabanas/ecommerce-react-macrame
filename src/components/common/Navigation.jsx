    ...
    return (
        <nav className="navigation" ref={navbar}>
            ...
            <ul className="navigation-menu-main">
                ...
                <li><NavLink activeClassName="navigation-menu-active" to={ROUTE.FEATURED_PRODUCTS}>Featured</NavLink>
                </li>
                <li><NavLink activeClassName="navigation-menu-active"
                             to={ROUTE.RECOMMENDED_PRODUCTS}>Recommended</NavLink></li>
            </ul>
